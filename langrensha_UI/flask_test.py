...
from db import get_user, save_user, save_room, add_room_members, get_rooms_for_user, get_room, is_room_member, \
 get_room_members, is_room_admin, update_room, remove_room_members, save_message, get_messages, get_room_rules
...
def create_room():
    ...
    if request.method == 'POST':
        ...
        if len(room_name) and len(usernames) and len(rolelist) and nvwu_flag and shangjing_flag:
            room_id = save_room(room_name, current_user.username, rolelist, nvwu_flag, shangjing_flag)
...
def view_room(room_id):
    ...
    if room and is_room_member(room_id, current_user.username):
        ...
        return render_template('view_room.html', username = current_user.username, room=room, room_rule = room_rule, room_members = room_members, messages = messages)
